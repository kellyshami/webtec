    ...
    public ResponseEntity<byte[]> downloadPdf() throws DocumentException {
        ...
        for (Form portfolio : portfolios) {
            dataBuilder.append("ID: ").append(portfolio.getId()).append("\n")
                    .append("Owner ID: ").append(portfolio.getStudentId()).append("\n")
                    .append("StudentName: ").append(portfolio.getStudentName()).append("\n")
                    .append("Course: ").append(portfolio.getCourse()).append("\n")
                    .append("Result: ").append(portfolio.getResult()).append("\n");
